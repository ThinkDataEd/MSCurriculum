...
**<h1>Section 1: Setting the Stage</h1>**
...
<table class="tg">
  ...
  <tr>
    <td class="tg-yj5y"><a href="../../unit1/lesson1">Lesson 1: </a>Meet the DSU Squad (DSU = Data Science Unit)</td>
    <td class="tg-88nc">data science <br> data <br> datum <br> survey questions<br> The Data Cycle <br> Consider Data (phase)<br> primary data</td>
...
B.II.4: Data collection via surveys</li></ul> </td>
  ...
  <tr>
    <td class="tg-yj5y"><a href="../../unit1/lesson2">Lesson 2: </a>Reconstructing the Scene</td>
    <td class="tg-88nc">representations</td>
  ...
  <tr>
    <td class="tg-yj5y"><a href="../../unit1/lesson3">Lesson 3: </a>Compiling the Suspect Dossiers</td>
    <td class="tg-88nc">observations<br>secondary data</td>
  ...
  <tr>
    <td class="tg-yj5y"><a href="../../unit1/lesson4">Lesson 4: </a>Acquiring &amp; Organizing Additional Evidence</td>
    <td class="tg-88nc">survey questions</td>
  ...
  <tr>
    <td class="tg-yj5y"><a href="../../unit1/lesson5">Lesson 5: </a>Structuring the Evidence</td>
    <td class="tg-88nc">data table<br>case<br> attributes <br> variable <br> missing value <br> numerical variable <br> categorical variable</td>
  ...
  <tr>
    <td class="tg-yj5y"><a href="../../unit1/lesson6">Lesson 6: </a>Our Detective Toolkit - CODAP</td>
    <td class="tg-88nc">CODAP<br> case card<br> case table</td>
  ...
  <tr>
    <td class="tg-yj5y"><a href="../../unit1/lesson7">Lesson 7: </a>What's in a Question?</td>
    <td class="tg-88nc">Pose Questions (phase) <br>statistical questions</td>
  ...
  <tr>
    <td class="tg-yj5y"><a href="../../unit1/progresscheck1">Progress Check 1: </a>Can You Read the Evidence?</td>
    <td class="tg-c3ow"></td>
